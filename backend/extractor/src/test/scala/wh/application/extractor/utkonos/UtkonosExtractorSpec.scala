...
class UtkonosExtractorSpec extends FlatSpec with Matchers {
  ...
  "Utkonos extractor" should "return right list of entries" in {
    ...
    extractor.extract(page).toList should be (
      List(
        ExtractedEntry(ExtractedShop("Утконос", "Москва"), "Молоко М Лианозовское ультрапастеризованное 3,2%, 950г", 5180, secondCategory, new URL("file:/images/photo/3074/3074902B.jpg?1337770127")),
        ExtractedEntry(ExtractedShop("Утконос", "Москва"), "Сливки Домик в деревне 10% стерилизованные, 480г", 7470, secondCategory, new URL("file:/images/photo/3051/3051861B.jpg?1342618109")),
        ExtractedEntry(ExtractedShop("Утконос", "Москва"), "Сливки Домик в деревне 20%, 200г", 7180, secondCategory, new URL("file:/images/photo/3049/3049025B.jpg?1337876707"))
      )
    )
  }
}
