...
class DixyExtractorSpec extends FlatSpec with Matchers {
  "Dixy extractor" should "return right list of entries" in {
    ...
    extractor.extract(page).toList.filter(_.shop.city.equals("Москва")).distinct should be(List(
        ...
        ExtractedEntry(shop, "ПАШТЕТ Нежный из птичьей печени ЕКГФ150 г", 5690, null, new URL("http://dixy.ru/sites/default/files/imagecache/dixy_action_block/actions/pashtet_pate_soft_nejniy_bird_liver_ekgf_150g_mru_24.02.2015.jpg")),
        ExtractedEntry(shop, "КОЛБАСА Балыковая Велком400 г", 27990, null, new URL("http://dixy.ru/sites/default/files/imagecache/dixy_action_block/actions/kolbasa_balik_velkom_400g_2pcs_mru_24.02.2015.jpg")),
